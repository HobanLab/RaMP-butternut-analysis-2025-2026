...
SSA symbol:             VT007
SSA name:               Chittenden County, Vermont
SSA version:            30
SSA version est.:       09/16/2025 08:49:12 PM
Spatial format:         ESRI Shapefile
Coordinate system:      Geographic Coordinate System (WGS84)

The spatial data for survey area VT007 does not include a complete set of
delineated map units.

This export also includes the following MS Access SSURGO template database:

Template DB name:       soildb_VT_2003.mdb
Template DB version:    36
Template DB state:      VT
