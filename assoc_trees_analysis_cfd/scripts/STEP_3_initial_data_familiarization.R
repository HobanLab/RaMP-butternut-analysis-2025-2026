...
plot(response ~ `alternate-leaf_dogwood`, data = df) 
plot(response ~ american_elm, data = df) 
plot(response ~ ash_spp, data = df) 
plot(response ~ basswood, data = df) 
plot(response ~ big_tooth_aspen, data = df) 
plot(response ~ birch_spp, data = df) 
plot(response ~ bitternut_hickory, data = df) 
plot(response ~ black_ash, data = df) 
plot(response ~ black_cherry, data = df) 
plot(response ~ black_walnut, data = df) 
plot(response ~ box_elder, data = df) 
plot(response ~ buckthorn, data = df) 
plot(response ~ butternut, data = df) 
plot(response ~ cedar_spp, data = df) 
plot(response ~ elderberry, data = df) 
if(any(colnames(df) %in% "elm_spp")){
  plot(response ~ elm_spp, data = df)
...
plot(response ~ green_ash, data = df) 
plot(response ~ hickory_spp, data = df) 
plot(response ~ honeysuckle, data = df) 
plot(response ~ ironwood, data = df) 
plot(response ~ lilac, data = df) 
plot(response ~ malus, data = df) 
plot(response ~ paper_birch, data = df)
plot(response ~ pin_cherry, data = df) 
plot(response ~ red_cedar, data = df) 
plot(response ~ red_maple, data = df) 
plot(response ~ serviceberry, data = df) 
plot(response ~ shagbark_hickory, data = df) 
plot(response ~ slippery_elm, data = df) 
plot(response ~ sugar_maple, data = df) 
plot(response ~ white_ash, data = df) 
plot(response ~ white_cedar, data = df) 
plot(response ~ white_oak, data = df) 
plot(response ~ yellow_birch, data = df)
